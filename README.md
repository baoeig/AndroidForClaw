...
- ✅ **Skill 扩展** — 五层优先级加载（extraDirs → Bundled → Managed → Plugin → Workspace）
- ✅ **Plugin Skills** — 插件 extensions 目录自动扫描加载
- ✅ **ClawHub 集成** — 原生支持从 ClawHub 发现和安装技能 (npm 待实现)
- ✅ **MCP 协议** — 标准 Model Context Protocol 支持
- ✅ **多模型支持** — Claude / GPT / Gemini 等主流 LLM
- ✅ **首次启动引导** — 自动检测未配置 API Key，引导用户快速设置模型
...
**📥 最新版本**: [v1.0.0](https://github.com/xiaomochn/AndroidForClaw/releases/latest) | **📦 浏览文件**: [releases/](releases/)
